              ...
              <div className="Bariloche">
                ...
                <section className="ImperdiblesBariloche">
                  <h4>Imperdibles en el centro de Bariloche</h4>
                      <p className="TextoViajes">
                       ...
                       así que anotate este plan, si queres aprovechar hasta el último minuto de tu viaje 
                       al sur. En cuanto a sabor, yo opte por comprar dulces en del turista y
                ...
                <section className="Alojamientos">
                   ...
                   <p className="TextoViajes">
                    ...
                    kioscos 24 hs, remiserias, hoteles, agencias de turismo y el famoso centro cívico. Además,
                    por allí pasa el transporte públicos que te lleva a los diferentes cerros
                    Pero bien, si lo que estás buscando es un poco más de tranquilidad, sin tanto ruido nocturno,
                    poder salir a comprar y sentirte como en el barrio de tu casa, la zona del balneario municipal que se ubica cerca de la Avenida Mitre es ideal para vos,
                    sin embargo, sería un punto intermedio, por qué este distrito se encuentra a unos 20 minutos caminando hasta el centro cívico (algunas calles empinadas) pero en particular, 
                    esta zona me encanto muchísimo, además es un lugar ideal para tomar fotos ya que no es tan concurrida.
                ...
                <section className="CerrosBariloche">
                  ...
                  (Tarifas)
                  Ascenso y descenso: Mayores $1600 - Menores $800 ARS (entre 5 y 12 años)
                  ...
                  Durante el camino de la ruta Nacional 40 y Provincial 82, encontrás miradores, cabañas, campings, y el lago Mascardi, otra parada obligatoria .
                  Podés contratar un combo de excursión y recorrerlo en una hora, porque te llevan a otros lugares turísticos o bien un paseo exclusivo hacia el cerro, el cuál te lleva 12 hs aproximadamente, es muy importante si vas con movilidad propia que tengas en cuenta el horario de ingreso y regreso.
                  Otro dato de color muy importante, es que tiene horarios con dirección única, desde Los Rápidos hasta Pampa Linda de 10:30 a 14:00 hs. 
                  Horario de regreso, desde Pampa Linda hasta Los Rápidos de 16:00 a 18:00 hs. 
                  Doble mano, de 19:30 a 09:00 hs.
                  </p>
                  <h6>Cerro Otto</h6>
                  <p className="TextoViajes">
                  En este cerro fue mi primera experiencia en Ski y por eso te digo que si tenes ganas de esquiar y no te animas por la altura, por los miedos y sensaciones que te produce una caída, dejame decirte que este cerro es todo lo contrario, si bien tiene una altura mínima, es ideal para principiantes o sin conocimiento alguno sobre ski. Te brindan una pequeña charla de 15 minutos y te entregan el equipamiento para esquiar, si vas en invierno necesitarás ropa abrigada. 
                  Se ubica en Av. de los Pioneros Km 5,000 y si bien se puede llegar en transporte púbico, no te lo recomiendo, ya que te deja en la entrada y luego tienes que caminar, excepto si decides tomar el teleférico (hay que tener en cuenta las condiciones climáticas, por qué en invierno a veces no se puede subir en teleférico), por eso lo recomendable es contratar una excursión o ir en un vehículo propio 
                  No creas que es solo para esquiar, por qué en su interior vas a encontrar una confitería giratoria y una galería de arte. En su exterior, vas a poder realizar actividades como caminatas con raquetas y cuentan con trineos por si querés deslizarte por la nieve. Sus lugares fotografiables son, el puente colgante, laberinto del Bosque, deck y sus terrazas panorámicas. La época ideal para ir, depende de las actividades que quieras realizar.
                  (Horarios y tarifas)
                  Precios actualizados, diciembre 2022. De lunes a sábados, el ascenso es de 10:00 a 16:30 hs y último descenso 18:15 hs. Ascenso y descenso del teleférico:
                  Mayores $4500 ARS
                  Mayores de 65 años $3500 ARS
                  Menores de 6 hasta 12 $3500 ARS
                  Solo ascenso o descenso $3500 ARS
                ...
                <section className="IslaYBosque">
                  ...
                  El precio de este lugar, dependerá de la agencia de turismo donde contrataras la excursión, tene en cuenta que ninguna incluye el acceso al parque nacional y la tasa de embarque. 
                  (Tarifas)
                  Precios actualizados, diciembre 2022. Los impuestos y accesos se abonan en efectivo en Puerto Pañuelo 
                  Ingreso al Parque Nacional
                  Extranjeros $2700 ARS 
                  Residentes nacionales $800  ARS 
                  Menores de 6-12 años $300 ARS
                  Menores hasta los 5 años y jubilados argentinos no abonan
                ...
                <section className="PuertoYCascada">
                  ...
                  Una vez en Puerto Blest, hay una hostería en donde se almuerza muy rico. Pasado ese break, te recomiendo que sigas la ruta para Bahía Blest y el lago Frías, donde nuevamente predominan aguas verdes que provienen de uno de los glaciares del cerro Tronador, límite natural entre Argentina y Chile.
                ...
                <div className="BuenosAires"></div>

                <div className="EntreRios"></div>

                <div className="Misiones"></div>

                <div className="Salta"></div>

            </div>

             <div className="ViajesBrasil"></div>
